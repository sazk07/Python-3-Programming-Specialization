...
check_item_type = lambda item_type : dict.keys(nested) if "key" else dict.values(nested)
check_if_in= lambda item,item_type : True if item in check_item_type(item_type) else False
